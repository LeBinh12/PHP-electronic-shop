<div class="sidebar custom-sidebar" style="top: 0; margin-top: 0; padding-top: 0;">
    ...
    <ul class="nav flex-column p-3">
        ...
        <li class="nav-item">
            <a class="nav-link" href="?page=products"><i class="fas fa-box"></i> Products</a>
        </li>
        <li class="nav-item">
            <a class="nav-link" href="#"><i class="fas fa-table"></i> Categories</a>
        </li>
        <li class="nav-item">
            <a class="nav-link" href="#"><i class="fas fa-truck"></i> Suppliers</a>
        </li>
        <li class="nav-item">
        ...
        <li class="nav-item">
            <a class="nav-link" href="#"><i class="fas fa-language"></i> Language</a>
        </li>
        <li class="nav-item">
