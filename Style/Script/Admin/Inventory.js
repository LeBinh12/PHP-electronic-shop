document.addEventListener('DOMContentLoaded', function() {
    const buttons = document.querySelectorAll('button.btn-primary[data-bs-toggle="modal"]');
    if (buttons.length === 0) {
        console.error('No buttons with class btn-primary[data-bs-toggle="modal"] found');
        return;
    }
    ...
    buttons.forEach(button => {
        button.addEventListener('click', function(e) {
            ...
            console.log('Button data:', { id, productName, stockQuantity });
